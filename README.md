...
- **Zoom Levels:** The maximum zoom level is determined by repeatedly halving the image size until it either reaches an
  odd
  width or is smaller than 128px.
- **Divisibility:** Ensure your image is easily divisible. For example, a width of 1366px is not optimal because it can
  only
